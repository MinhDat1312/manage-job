...
public class PanelActionViewCreateResume extends JPanel {
	
	private ButtonAction view;
	private ButtonAction create;
	
	public PanelActionViewCreateResume() {
        initComponent();
    }
	...
	public void initComponent() {
		...
		create.setIcon(new ImageIcon(getClass().getResource("/image/icon/hoso24.png")));
