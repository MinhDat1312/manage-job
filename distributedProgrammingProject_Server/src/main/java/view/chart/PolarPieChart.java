...
public class PolarPieChart extends JPanel{
	
	public static enum PeiChartType {
        DEFAULT, DONUT_CHART
    }
	
	private final ArrayList<ModelPieChart> models;
    ...
    public PolarPieChart() {
    	setOpaque(false);
    	setPreferredSize(new Dimension(300,300));
    	
    	models=new ArrayList<ModelPieChart>();
    ...
    public ArrayList<ModelPieChart> getList(){
    	return models;
    }
...
//        double recX = labelX -= width / 2;
        ...
        recX += paceH;
        g2.setFont(new Font("Segoe UI",1,16).deriveFont(Font.PLAIN, fontSize));
    ...
    private void createChart(Graphics g) {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            g2.setFont(new Font("Segoe UI",1,16).deriveFont(fontSize));
